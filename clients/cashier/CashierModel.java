...
public class CashierModel extends Observable
{
  ...
  /**
 * Voids the sale of a product and replenishes stock if the product is in the basket.
 */
  public void doVoid() {
    String theAction = "";
    int    amount  = 1;
    if( theState != State.checked ){ // If has not been checked with customer
      ...
      if (theBasket == null){ // Otherwise, check if basket doesn't exists
        ...
        } else { // if the product has NOT been found
          theAction = "!!! Item is NOT in basket";       // alert user saying it's not in the basket
        }
      }
    }
    theState = State.process;                   // All Done
